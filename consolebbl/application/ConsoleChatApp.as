package consolebbl.application
{
   ...
   public class ConsoleChatApp extends MovieClip
   {
      ...
      private var _bipEnabled:Boolean;
      
      public var ch_modochat:CheckBox;
      ...
      private var chatPreferences:SharedObject;
      ...
      public function ConsoleChatApp()
      {
         ...
         this.chatPreferences = SharedObject.getLocal("consoleChatPrefs");
         if(this.chatPreferences.data.hasOwnProperty("bipEnabled"))
         {
            this.bipEnabled = this.chatPreferences.data.bipEnabled;
         }
         else
         {
            this.bipEnabled = true;
         }
         this.ch_modochat.gotoAndStop(!!this.bipEnabled ? "etat_true_enable_true" : "etat_false_enable_true");
         this.ch_modochat.addEventListener("onChanged",onCheckBoxChanged,false,0,true);
      }
      
      public static function get bipEnabled() : Boolean
      {
         return ConsoleChatApp.instance._bipEnabled;
      }
      ...
      {
         this.bipEnabled = Boolean(this.ch_modochat.value);
         this.chatPreferences.data.bipEnabled = this.bipEnabled;
         this.chatPreferences.flush();
         this.ch_modochat.gotoAndStop(!!this.bipEnabled ? "etat_true_enable_true" : "etat_false_enable_true");
      }
      ...
      public function redrawSize() : *
      {
         ...
         this.ch_modochat.x = parent.width - this.ch_modochat.width + 2;
         this.ch_modochat.y = parent.height - this.ch_modochat.height + 1;
         this.vs_selgrade.x = parent.width - this.ch_modochat.width - this.vs_selgrade.width;
