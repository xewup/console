package consolebbl.application
{
   ...
   public class InsultronViewer extends MovieClip
   {
      ...
      public var ch_insultron:CheckBox;
      
      public var liste:List;
      
      public var bipInsultronEnabled:Boolean;
      ...
      public function init(param1:Event) : *
      {
         if(stage)
         {
            ...
            if(this.chatPreferences.data.hasOwnProperty("bipInsultronEnabled"))
            {
               this.bipInsultronEnabled = this.chatPreferences.data.bipInsultronEnabled;
            }
            else
            {
               this.bipInsultronEnabled = false;
            }
            this.ch_insultron.gotoAndStop(this.bipInsultronEnabled ? "etat_true_enable_true" : "etat_false_enable_true");
            this.ch_insultron.addEventListener("onChanged",onCheckBoxChanged,false,0,true);
      ...
      {
         this.bipInsultronEnabled = Boolean(this.ch_modochat.value);
         this.chatPreferences.data.bipInsultronEnabled = this.bipInsultronEnabled;
      ...
      public function redrawSize() : *
      {
         ...
         this.ch_insultron.x = this.liste.x + this.liste.width - this.ch_insultron.width;
         this.ch_insultron.y = this.liste.y + this.liste.height;
